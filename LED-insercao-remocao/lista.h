...
int lista_buscar(const LISTA *lista, REGISTRO dado, unsigned int *posicao); // nao ordenada
int lista_ordenada_buscar(const LISTA *lista, REGISTRO dado, unsigned int *posicao); // ordenada
